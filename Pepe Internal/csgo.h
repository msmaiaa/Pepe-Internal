...
namespace offsets
{
	...
	constexpr ptrdiff_t dwEntityList = 0x4DBD61C;
	constexpr ptrdiff_t dwForceAttack = 0x31EDB34;
	constexpr ptrdiff_t dwForceAttack2 = 0x31EDB40;
	constexpr ptrdiff_t dwForceBackward = 0x31EDB7C;
	constexpr ptrdiff_t dwForceForward = 0x31EDB88;
	constexpr ptrdiff_t dwForceJump = 0x526742C;
	constexpr ptrdiff_t dwForceLeft = 0x31EDBA0;
	constexpr ptrdiff_t dwForceRight = 0x31EDB94;
	constexpr ptrdiff_t dwGameDir = 0x627700;
	constexpr ptrdiff_t dwGameRulesProxy = 0x52DA70C;
	constexpr ptrdiff_t dwGetAllClasses = 0xDCBA7C;
	constexpr ptrdiff_t dwGlobalVars = 0x588CF0;
	constexpr ptrdiff_t dwGlowObjectManager = 0x5305B18;
	constexpr ptrdiff_t dwInput = 0x520EBE0;
	constexpr ptrdiff_t dwInterfaceLinkList = 0x954004;
	constexpr ptrdiff_t dwLocalPlayer = 0xDA344C;
	constexpr ptrdiff_t dwMouseEnable = 0xDA8F98;
	constexpr ptrdiff_t dwMouseEnablePtr = 0xDA8F68;
	constexpr ptrdiff_t dwPlayerResource = 0x31EBEC0;
	constexpr ptrdiff_t dwRadarBase = 0x51F2394;
	constexpr ptrdiff_t dwSensitivity = 0xDA8E34;
	constexpr ptrdiff_t dwSensitivityPtr = 0xDA8E08;
	constexpr ptrdiff_t dwSetClanTag = 0x8A130;
	constexpr ptrdiff_t dwViewMatrix = 0x4DAEF34;
	constexpr ptrdiff_t dwWeaponTable = 0x520F6A4;
	constexpr ptrdiff_t dwWeaponTableIndex = 0x326C;
	constexpr ptrdiff_t dwYawPtr = 0xDA8BF8;
	constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xDADE98;
	constexpr ptrdiff_t dwbSendPackets = 0xD7B42;
	constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA7050;
	constexpr ptrdiff_t m_pStudioHdr = 0x2950;
	constexpr ptrdiff_t m_yawClassPtr = 0xDA8BF8;
	constexpr ptrdiff_t m_pitchClassPtr = 0x51F2630;
	...
	constexpr ptrdiff_t model_ambient_min = 0x58C00C;
	constexpr ptrdiff_t set_abs_angles = 0x1E37C0;
	constexpr ptrdiff_t set_abs_origin = 0x1E3600;
	constexpr ptrdiff_t is_c4_owner = 0x3C0CA0;
	constexpr ptrdiff_t force_update_spectator_glow = 0x3B3D5A;
	constexpr ptrdiff_t anim_overlays = 0x2990;
	constexpr ptrdiff_t m_flSpawnTime = 0x103C0;
	constexpr ptrdiff_t find_hud_element = 0x2BA227A0;

	//netvars

	constexpr ptrdiff_t m_ArmorValue = 0x113CC;
	...
	constexpr ptrdiff_t m_bHasDefuser = 0x113DC;
	constexpr ptrdiff_t m_bHasHelmet = 0x113C0;
	...
	constexpr ptrdiff_t m_iCrosshairId = 0x11438;
	...
	constexpr ptrdiff_t m_angEyeAnglesX = 0x113D0;
	constexpr ptrdiff_t m_angEyeAnglesY = 0x113D4;
