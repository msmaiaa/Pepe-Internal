...
namespace offsets
{
	...
	constexpr ptrdiff_t dwEntityList = 0x4DBD5CC;
	constexpr ptrdiff_t dwForceAttack = 0x31EDB20;
	constexpr ptrdiff_t dwForceAttack2 = 0x31EDB2C;
	constexpr ptrdiff_t dwForceBackward = 0x31EDB74;
	constexpr ptrdiff_t dwForceForward = 0x31EDB50;
	constexpr ptrdiff_t dwForceJump = 0x52673DC;
	constexpr ptrdiff_t dwForceLeft = 0x31EDB68;
	constexpr ptrdiff_t dwForceRight = 0x31EDAF0;
	constexpr ptrdiff_t dwGameDir = 0x627700;
	constexpr ptrdiff_t dwGameRulesProxy = 0x52DA6BC;
	constexpr ptrdiff_t dwGetAllClasses = 0xDCBA7C;
	constexpr ptrdiff_t dwGlobalVars = 0x588CF0;
	constexpr ptrdiff_t dwGlowObjectManager = 0x5305AE0;
	constexpr ptrdiff_t dwInput = 0x520EB90;
	constexpr ptrdiff_t dwInterfaceLinkList = 0x954344;
	...
	constexpr ptrdiff_t dwPlayerResource = 0x31EBE70;
	constexpr ptrdiff_t dwRadarBase = 0x51F2344;
	...
	constexpr ptrdiff_t dwViewMatrix = 0x4DAEEE4;
	constexpr ptrdiff_t dwWeaponTable = 0x520F654;
	...
	constexpr ptrdiff_t dwbSendPackets = 0xD7BD2;
	constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA7050;
	constexpr ptrdiff_t find_hud_element = 0x287D28C0;
	constexpr ptrdiff_t force_update_spectator_glow = 0x3B399A;
	constexpr ptrdiff_t interface_engine_cvar = 0x3E9EC;
	constexpr ptrdiff_t is_c4_owner = 0x3C08F0;
	constexpr ptrdiff_t m_bDormant = 0xED;
	constexpr ptrdiff_t m_flSpawnTime = 0x103C0;
	constexpr ptrdiff_t m_pStudioHdr = 0x2950;
	constexpr ptrdiff_t m_pitchClassPtr = 0x51F25E0;
